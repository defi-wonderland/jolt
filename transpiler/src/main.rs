...
//! - Stages 1-7: Sumcheck verifications (including HammingWeight claim reduction)
//!
...
use transpiler::{
    gnark_codegen, symbolize_proof,
    symbolize::{symbolize_io_device, symbolize_bytecode, fixup_bytecode_witnesses},
    AstCommitmentScheme, AstOpeningAccumulator, SelectedAstTranscript,
};
...
fn main() {
    ...
    >::new_with_accumulator(
        ...
        symbolic_proof,
        io_device,
        None, // trusted_advice_commitment (not used in stages 1-7)
        transcript,
        accumulator,
    );
